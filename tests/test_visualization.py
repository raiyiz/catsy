...
class TestStateVisualizations:
    """Static views of a single Gaussian state."""

    @pytest.mark.visual
    def test_visualizations_return_figures_without_showing(self) -> None:
        state = (
    ...
    @pytest.mark.visual
    def test_phase_space_uses_displacement(self) -> None:
        state = (
            GaussianState.vacuum(("a",))
...
class TestEvolutionVisualizations:
    """Time-dependent views of Gaussian-state dynamics."""

    @pytest.mark.visual
    def test_phase_space_evolution(self) -> None:
    ...
    @pytest.mark.visual
    def test_wigner_and_covariance_evolution(self) -> None:
        states, times = _evolution()
        ...
        # Three Wigner snapshots plus one shared colorbar; no empty data panels.
    ...
    @pytest.mark.visual
    def test_evolution_animation(self) -> None:
        states, times = _evolution()
