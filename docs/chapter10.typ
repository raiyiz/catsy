...
This closing chapter distills the previous nine chapters into a practical overview: how to import the package, how the modules relate to each other, which conventions apply package-wide, and how to run the test suite.
